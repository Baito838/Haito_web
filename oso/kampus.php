  ...
  <nav class="navbar sticky-top d-flex justify-content-between p-2" style="background-color: #AD61C8; box-sizing: border-box;">   
      ...
      <div style="background-color: #CE8AE2;" class="offcanvas offcanvas-start text-light" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
        <div class="offcanvas-header">
          <h5 class="offcanvas-title" id="offcanvasWithBothOptionsLabel">Menu <i class="fa-solid fa-house"></i></h5>
                    ...
                    <div class="modal-body">
                      <input type="hidden" name="id" id="id" value="<?= $data['idk'] ?>">
                        ...
                        <input required oninvalid="this.setCustomValidity('Wajib masukkan nama')"
                          oninput="this.setCustomValidity('')" class="form-control mb-2" type="text" name="nku" id="nku<?= $no ?>" value="<?= $data['nama']?>"/>
                        <label for="taso" class="mb-1">Tahu Bakso</label>
                        <input required oninvalid="this.setCustomValidity('Penambahan tahu bakso / 0 ')"
                          oninput="this.setCustomValidity('')" class="form-control mb-2" type="number" name="tku" id="tku<?= $no ?>" min="0" step="2000" value="<?= $data['taso']?>"/>
                        ...
                        <input required oninvalid="this.setCustomValidity('Penambahan gorengan lain / 0')"
                          oninput="this.setCustomValidity('')" class="form-control mb-2" type="number" name="gku" id="gku<?= $no ?>" min="0" step="1500" value="<?= $data['gorengan']?>"/>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="post" action="config.php">
                ...
                <input required oninvalid="this.setCustomValidity('Wajib masukkan nama')"
                  oninput="this.setCustomValidity('')" class="form-control mb-2" type="text" name="nk" id="nk" placeholder="Masukkan Nama Pelanggan"/>
                <label for="taso" class="mb-1">Tahu Bakso</label>
                <input required oninvalid="this.setCustomValidity('Input pembelian tahu bakso / 0 ')"
                  oninput="this.setCustomValidity('')" class="form-control mb-2" type="number" name="tk" id="tk" min="0" step="2000" placeholder="Harga Tahu 2.000/pcs"/>
                <label for="gorengan" class="mb-1">Gorangan lain</label>
                <input required oninvalid="this.setCustomValidity('Input pembelian gorengan lain / 0')"
                  oninput="this.setCustomValidity('')" class="form-control mb-2" type="number" name="gk" id="gk" min="0" step="1500" placeholder="Harga Gorangan 1.500/pcs"/>
                <label for="total">Total</label>
