                  ...
                  <div class="modal-content">
                    ...
                    <form method="POST" action="config.php">
                      <div class="modal-body">
                        ...
                        <input required oninvalid="this.setCustomValidity('Wajib masukkan nama')" oninput="this.setCustomValidity('')" class="form-control mb-2" type="text" name="nsu" id="nsu<?= $no ?>" value="<?= $data['nama'] ?>" />
                        <label for="taso" class="mb-1">Tahu Bakso</label>
                        <input required oninvalid="this.setCustomValidity('Penambahan tahu bakso / 0 ')" oninput="this.setCustomValidity('')" class="form-control mb-2" type="number" name="tsu" id="tsu<?= $no ?>" min="0" step="2000" value="<?= $data['taso'] ?>" />
                        <label for="gorengan" class="mb-1">Gorangan lain</label>
                        <input required oninvalid="this.setCustomValidity('Penambahan gorengan lain / 0')" oninput="this.setCustomValidity('')" class="form-control mb-2" type="number" name="gsu" id="gsu<?= $no ?>" min="0" step="1500" value="<?= $data['gorengan'] ?>" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="config.php">
          ...
          <input required oninvalid="this.setCustomValidity('Wajib masukkan nama')" oninput="this.setCustomValidity('')" class="form-control mb-2" type="text" name="ns" id="ns" placeholder="Masukkan Nama Pelanggan" />
          <label for="taso" class="mb-1">Tahu Bakso</label>
          <input required oninvalid="this.setCustomValidity('Input pembelian tahu bakso / 0 ')" oninput="this.setCustomValidity('')" class="form-control mb-2" type="number" name="ts" id="ts" min="0" step="2000" placeholder="Harga Tahu 2.000/pcs" />
          <label for="gorengan" class="mb-1">Gorangan lain</label>
          <input required oninvalid="this.setCustomValidity('Input pembelian gorengan lain / 0')" oninput="this.setCustomValidity('')" class="form-control mb-2" type="number" name="gs" id="gs" min="0" step="1500" placeholder="Harga Gorangan 1.500/pcs" />
          <hr>
          <label for="total">Total</label>
